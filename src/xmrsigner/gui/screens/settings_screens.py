...
@dataclass
class SettingsQRConfirmationScreen(ButtonListScreen):  # TODO: 2024-06-15, not sure if we need it, added from rebase from main to 0.7.0 from SeedSigner
